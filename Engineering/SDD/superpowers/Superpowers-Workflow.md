...
![Superpowers Skills Architecture](superpowers-skills-architecture.drawio.svg)
...
![Superpowers Core Workflow](superpowers-core-workflow.drawio.svg)
...
![Superpowers Debugging Workflow](superpowers-debugging-workflow.drawio.svg)
...
![Superpowers Subagent Architecture](superpowers-subagent-architecture.drawio.svg)
...
![Superpowers Skill Lifecycle](superpowers-skill-lifecycle.drawio.svg)
...
- [GSD-Workflow](GSD-Workflow.md) — GSD meta-prompting and context engineering
- [OpenSpec-Workflow](OpenSpec-Workflow.md) — OpenSpec workflows, delta specs
