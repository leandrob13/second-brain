...
![Harness Architecture](harness-architecture.drawio.svg)
...
![Agent Lifecycle](agent-lifecycle.drawio.svg)
...
![Orchestration Patterns](orchestration-patterns.drawio.svg)
