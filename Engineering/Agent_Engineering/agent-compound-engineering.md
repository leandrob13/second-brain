...
![Compound Engineering Loop](compound-engineering-loop.drawio.svg)
...
![Agent Design Patterns](agent-design-patterns.drawio.svg)
...
![Compound AI Architecture](compound-ai-architecture.drawio.svg)
