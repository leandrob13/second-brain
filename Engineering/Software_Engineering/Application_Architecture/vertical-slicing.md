...
![Layered Architecture Problem](01-layered-architecture.svg)
...
![Vertical Slice Architecture](02-vertical-slice-architecture.svg)

Each slice is independent. Adding, changing, or deleting a feature touches exactly one slice.

### Anatomy of a Single Slice

![Anatomy of a Single Slice](03-single-slice-anatomy.svg)
...
![CQRS — Commands and Queries](04-cqrs.svg)
...
![Mediator Pattern — Sequence Diagram](05-mediator-pattern.svg)
...
![Shared Infrastructure vs Slices](06-shared-vs-slice.svg)
...
![Relationship to Other Architectural Styles](07-architecture-relationships.svg)
