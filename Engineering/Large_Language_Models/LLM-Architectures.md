...
![Transformer Architecture](transformer-architecture.drawio.svg)
...
![Attention Mechanism](attention-mechanism.drawio.svg)
...
![LLM Architecture Types](llm-architecture-types.drawio.svg)
...
![LLM Training Pipeline](llm-training-pipeline.drawio.svg)
...
![Mixture of Experts Architecture](moe-architecture.drawio.svg)
...
![LLM Evolution Timeline](llm-evolution-timeline.drawio.svg)
