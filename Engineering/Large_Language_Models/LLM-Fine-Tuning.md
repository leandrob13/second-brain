...
![LLM Customization Decision Tree](llm-finetuning-decision-tree.drawio.svg)
...
![LLM Fine-Tuning Pipeline](llm-finetuning-pipeline.drawio.svg)
...
![PEFT Methods Comparison](llm-peft-methods.drawio.svg)
