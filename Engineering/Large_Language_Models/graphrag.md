...
![GraphRAG Indexing Pipeline](graphrag-indexing-pipeline.drawio.svg)
...
![GraphRAG Query Flow: Local vs Global](graphrag-query-flow.drawio.svg)
...
![GraphRAG vs Traditional RAG](graphrag-vs-rag.drawio.svg)
